...
def run_experiment_inline(config, output_dir, exp_metadata=None):
    ...
    try:
        ...
        # Create NovelD_PPO agent with experiment hyperparameters
        agent = NovelD_PPO(
            env,
            alpha=config['alpha'],
...
def main():
    parser = argparse.ArgumentParser(description='Run all NovelD experiments (fast version)')
    ...
    parser.add_argument('--subset', type=str, default=None,
                        choices=['alpha', 'update_proportion', 'int_gamma', 'ent_coef'],
    ...
    print("NovelD Hyperparameter Ablation Experiments (Fast Mode)")
