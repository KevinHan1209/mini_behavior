...
class GearPole(FurnitureObj):
    def __init__(self, width=1, height=1, color='l_blue', name='gear_box'):
        super(GearPole, self).__init__('bucket', width, height, {0}, color, name, can_contain={0})

class MusicBox(FurnitureObj):
    def __init__(self, width = 1, height = 1, color='green', name = 'music_box'):
        super(MusicBox, self).__init__('music_box', width, height, {0}, color, name, can_contain = {0}, can_seebehind = True)
